...
}</code></pre><pre id="15138a47-4a51-80df-8263-ea5e450e6a53" class="code"><code class="language-Java">public class ClientHandler implements Runnable {
